...
{{-- --------------------------------------------------------------------------- --}}
            <div class="l-content__header">
              <p class="c-category-ttl c-category-ttl--topics">
                <span class="c-category-ttl__en">Rule</span>
                <span class="c-category-ttl__jp">利用規約</span>
              </p>
            </div>
            <div class="l-content__body">
              ...
              <div class="list_header_normal"; style="width:100%;">利用規約</div>

              <div class="gray_sub_header">第1条（適用）</div>
              ...
              <div class="gray_sub_header">第2条（利用登録）</div>
              ...
              <div class="gray_sub_header">第3条（ユーザーIDおよびパスワードの管理）</div>
              ...
              <div class="gray_sub_header">第4条（利用料金および支払方法）</div>
              ...
              <div class="gray_sub_header">第5条（禁止事項）</div>
              ...
              <div class="gray_sub_header">第6条（サービスの提供の停止等）</div>
              ...
              <div class="gray_sub_header">第7条（著作権）</div>
              ...
              <div class="gray_sub_header">第8条（利用制限および登録抹消）</div>
              ...
              <div class="gray_sub_header">第9条（退会）</div>
              ...
              <div class="gray_sub_header">第10条（保証の否認および免責事項）</div>
              ...
              <div class="gray_sub_header">第11条（サービス内容の変更等）</div>
              ...
              <div class="gray_sub_header">第12条（利用規約の変更）</div>
              ...
              <div class="gray_sub_header">施行・改定</div>
