            ...
            <div class="l-main__content">
                ...
                <div class="p-error-404__content">
                    ...
                    <h1 class="c-error-title">
                        ...
                        <span class="c-error-title__jp">404 : Not Found</span>
                    </h1>
                    </div>
                    <p class="p-error-404__text"><b>ページが見つかりません</b><br><span style="font-size:85%;">（URL入力ミス or リンク設定不備 or ページ削除済）</span></p>
                </div>
