            ...
            <div class="l-content__body">
                ...
                <form method="POST" action="{{route('diary.store')}}" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input type="text" name="diary_title" id="diary_title" value="{{old('diary_title')}}">
                    </div>
                    <p>&nbsp;</p>
                    <div>
                    ...
                    <div>
                        ...
                        <textarea name="diary_body" id="diary_body" cols="50" rows="10">{{old('diary_body')}}</textarea>
                    </div>
                    <p>&nbsp;</p>
                    <div>
                        ...
                        <select id="diary_personality" name="diary_personality">
                            ...
                            @foreach ($ary as $value)
                                <option value='{{$value}}' @if($value === old('diary_personality')) selected @endif>{{$value}}</option>
                            @endforeach
                        </select>
                    </div>
                    <p>&nbsp;</p>
                    <div>
                        ...
                        <select id="diary_weather" name="diary_weather">
                            ...
                            <option disabled="disabled" selected>選択してください</option>
                            @foreach ($ary as $value)
                                <option value='{{$value}}' @if($value === old('diary_weather')) selected @endif>{{$value}}</option>
                            @endforeach
                        </select>
                    </div>
                    <p>&nbsp;</p>
